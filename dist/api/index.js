...
const monthlyLeaveUsage_route_1 = __importDefault(
  require("../routes/monthlyLeaveUsage.route")
);
const monthlyOvertimeUsage_route_1 = __importDefault(
  require("../routes/monthlyOvertimeUsage.route")
);
